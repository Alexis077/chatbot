module Intention
  module RequestPaperRolls
   class Create
     ...
     validates :quantity, numericality: { only_integer: true, message: I18n.t('intention.request_paper_rolls.errors.invalid_quantity') }
     ...
     def validate
      @errors_messages << self.errors.messages.values unless valid?
     ...
     def create_purchase_request!
      ...
      return Result.new(valid: false, errors: [I18n.t('intention.request_paper_rolls.insufficient_balance')]) if (balance - total) <= 0
